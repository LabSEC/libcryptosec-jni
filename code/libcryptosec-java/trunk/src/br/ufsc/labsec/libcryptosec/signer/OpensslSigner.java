...
public class OpensslSigner {
	...
	private static native byte[] _sign(int key, byte[] hash, String algorithm);
	private static native boolean _verify(int key, byte[] signature, byte[] hash, String algorithm);
