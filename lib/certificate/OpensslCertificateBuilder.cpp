...
JNIEXPORT void JNICALL Java_br_ufsc_labsec_libcryptosec_certificate_OpensslCertificateBuilder__1alterSubject(JNIEnv* env, jobject obj, jlong _rdnSequenceReference)
{
...
JNIEXPORT void JNICALL Java_br_ufsc_labsec_libcryptosec_certificate_OpensslCertificateBuilder__1setIssuer(JNIEnv* env, jobject obj, jlong _issuerReference)
{
	CertificateBuilder* builder = Util::getInstance<CertificateBuilder*>(env, obj);
