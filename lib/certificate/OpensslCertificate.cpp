...
jint Java_br_ufsc_labsec_libcryptosec_certificate_OpensslCertificate__1init__Ljava_lang_String_2(JNIEnv* env, jobject obj, jstring _pemEncoded)
{
	try{
...
jint Java_br_ufsc_labsec_libcryptosec_certificate_OpensslCertificate__1init___3B(JNIEnv* env, jobject obj, jbyteArray _derEncoded)
{
	try{
